...
@section('title', 'Siswa Ditolak')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-xl font-semibold text-gray-800 mb-4">Daftar Siswa Ditolak</h2>

    {{-- Form Pencarian --}}
    <div class="mb-4">
        <form method="GET" action="{{ route('admin.ditolak.index') }}" class="flex gap-2">
    ...
    <table class="w-full border-collapse border border-gray-300 text-sm">
        ...
        <tbody>
            @foreach ($pendaftars as $index => $ppdb)
                <tr class="hover:bg-red-50 text-center">
    ...
    @else
        <p class="text-gray-500 text-center py-6">Belum ada siswa yang ditolak.</p>
    @endif
</div>
@endsection
